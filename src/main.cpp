...
#define TFT_BRIGHTNESS 200                                                          /* define TFT brightness */
...
const int8_t  servoH_pin = 10, servoV_pin = 11,                                     /* servo control pins */  
              p_resE = A0, p_resW = A1, 
              p_resS = A2, p_resN = A3;                                             /* photoresistor value read pins */
    
float vout, vcc;                                                                    /* voltage of battery */  
int8_t percent = 50;                                                                /* percentage of battery */

int16_t servoH_pos = 90, servoV_pos = 90,                                           /* servo position */
    lightE, lightW, lightS, lightN,                                                 /* photoresistor value */
    hr, min, sec, day, mth, yr, dow,                                                /* time */
    bav;                                                                            /* battery analog value */
...
void value_tester()                                                                 /* print value to test function */
{
